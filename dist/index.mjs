...
//OH easter egg ;)
const $67c46d86d9d50c48$var$WIF = "";
...
const $c3676b79c37149df$var$URL_RAVENCOIN_MAINNET = "https://rpc.aittcoin.org/rpc";
class $c3676b79c37149df$export$bcca3ea514774656 {
   ...
   */ sweep(WIF, onlineMode) {
    ...
    async init(options) {
        ...
        const ACCOUNT = 0;
        this.first_ext_address = (0, $93qLg$ravenrebelsravencoinkey).getAddressByPath(this.network, hdKey, `m/44'/${coinType}'/${ACCOUNT}'/0/${0}`).address;
